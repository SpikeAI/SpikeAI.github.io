...
BLOG_AUTHOR = "Laurent Perrinet"  # (translatable)
BLOG_TITLE = "SpikeAI"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://spikeai.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://spikeai.github.io/"
BLOG_EMAIL = "laurent.perrinet@univ-amu.fr"
BLOG_DESCRIPTION = "Information about research, publications and events"  # (translatable)
